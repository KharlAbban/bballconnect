  ...
  return (
    <div className='relative text-pageLightColor h-full w-full flex items-center justify-center max-w-[1600px]'>
      <div className='max-lg:hidden lg:w-1/2 h-full'>
        <img src='/jumbotron_bg.jpg' className='brightness-75 h-full w-full object-cover' />
      </div>
      <div className='w-full lg:w-1/2 h-full flex items-center relative justify-center'>
        <img src="/logo.png" className='w-36 brightness-50 absolute top-9 left-7' alt="" />
        <img src="/logo_gray.png" className='max-xl:hidden w-12 brightness-50 absolute bottom-5 right-8' alt="" />
        <img src="/logo_white.png" className='w-24 brightness-50 absolute lg:top-3/4 max-lg:bottom-8 max-lg:right-8 lg:left-8' alt="" />
        ...
        <div className='my-auto w-full xl:w-4/5 xl:h-4/5 xl:px-4 lg:pr-8 px-8 lg:text-end relative'>
          <h3 className='flex items-center lg:justify-end justify-center xl:mb-8 mb-6 pt-1'>
            <img src="/logo.png" className='lg:w-16 w-24 float-end' alt="" />
          </h3>
